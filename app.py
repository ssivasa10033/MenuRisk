...
model: Optional[MenuPriceOptimizer] = None
last_results: Dict = {}
...
def optimize_prices():
    ...
    try:
        ...
        optimized = model.optimize_prices(
            data, target_sharpe=target_sharpe, min_margin=min_margin
        )
...
def health_check():
    ...
    return jsonify(
        {"status": "healthy", "model_trained": model is not None and model.is_trained}
    )
