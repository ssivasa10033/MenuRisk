...
class ModelVisualizer:
    ...
    def plot_model_performance(
        ...
        """
        axes[1, 1].text(
            0.1, 0.5, summary_text, fontsize=11,
    ...
    def plot_feature_importance(
        ...
        for i, (idx, row) in enumerate(df_sorted.iterrows()):
            ax.text(
                row['importance'] + 0.01, i, f"{row['importance']:.3f}",
    ...
    def plot_portfolio_metrics(
        ...
        if recs:
            ...
            axes[1, 0].pie(
                rec_counts.values, labels=rec_counts.index,
    ...
    def plot_category_analysis(
        ...
        if 'category' in df.columns:
            ...
            data_by_cat = [df[df['category'] == c]['predicted_margin'].values for c in categories]
        ...
        if 'season' in df.columns:
            ...
            axes[1, 0].plot(
                season_margins.index, season_margins.values,
        ...
        if 'category' in df.columns:
            ...
            for cat in df['category'].unique():
                ...
                axes[1, 1].scatter(
                    cat_data['cogs'], cat_data['current_price'],
